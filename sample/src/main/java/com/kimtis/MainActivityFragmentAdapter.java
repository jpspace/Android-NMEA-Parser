...
/**
 * Created by uiseok on 2016-09-07.
 */
public class MainActivityFragmentAdapter extends FragmentPagerAdapter implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    static class DummyTabFactory implements TabHost.TabContentFactory {
        ...
        public View createTabContent(String tag) {
            View v = View.inflate(mContext, R.layout.tab_view,null);
    ...
    public MainActivityFragmentAdapter(FragmentActivity activity, TabHost tabHost,
                       ViewPager pager) {
        this(activity,activity.getSupportFragmentManager(),tabHost,pager);
    }

    public MainActivityFragmentAdapter(Context context, FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
